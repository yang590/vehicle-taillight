...
#custom
# pretrained = './pretrained/slowfast/videoswin/slowfast_r50_256p_4x16x1_256e_kinetics400_rgb_20200728-145f1097.pth'
model=dict(backbone=dict(pretrained=None),
           cls_head=dict(num_classes=5, loss_cls=dict(type='CrossEntropyLoss')),
