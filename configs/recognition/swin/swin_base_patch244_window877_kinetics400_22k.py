...
#custom
pretrained = '/home/data1/data_yj/pretrained/swin/videoswin/swin_base_patch4_window7_224_22k.pth'
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.2, pretrained=pretrained),
           cls_head=dict(num_classes=4, spatial_type=None, loss_cls=dict(type='BCELoss')),
...
ann_file_train = 'datas/taillight/labels_train_20231106.json'
ann_file_val = 'datas/taillight/labels_val_20231106.json'
