...
#custom
pretrained = './pretrained/swin/videoswin/swin_small_patch4_window7_224_22k.pth'
model=dict(backbone=dict(patch_size=(4,4,4), drop_path_rate=0.1, pretrained=pretrained),
           cls_head=dict(num_classes=4, spatial_type='avg', loss_cls=dict(type='BCELoss')),
...
# ann_file_test = './carlight/train/test.json'
...
# evaluation = dict(
#     interval=1, metrics=['mean_cls_accuracy'])
